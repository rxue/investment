...
from investment.market_quote.yahoo_finance_fetcher import fetch_company, fetch_closing_price
...
def find_closing_price_by_op_symbol(op_symbol:str, date: datetime) -> Price:
    company = _find_company_by_op_symbol(op_symbol)
    return Price(company=_find_company_by_op_symbol(op_symbol),
...
def main():
    match sys.argv[1]:
        case "closing_price":
            ...
            print(find_closing_price_by_op_symbol(symbol, date))
        case "company":
