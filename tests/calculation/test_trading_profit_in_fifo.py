...
def test_stock_calculate_trading_profit_in_fifo_base():
    ...
    assert calculate_trading_profit_in_fifo(transactions)[0] == 5000


def test_stock_calculate_trading_profit_in_fifo_order():
    ...
    profit, remaining_lots = calculate_trading_profit_in_fifo(transactions)
...
def test_sell_across_multiple_buys():
    ...
    assert calculate_trading_profit_in_fifo(transactions)[0] == 10000


def test_no_transactions():
    """Empty transaction list returns zero profit."""
    transactions = []
    assert calculate_trading_profit_in_fifo(transactions)[0] == 0
